...
/* FASE 1 */ - MODELAGEM CONCEITUAL - RASCUNHO
/* FASE 2 */ - MODELAGEM LÓGICA - QUALQUER PROGRAMA DE MODELAGEM
...
/* SINTAXE B[ASICA PARA INSERÇÃO - INSERT INTO TABLEA... */

/* FORMA 01 - OMITINDO AS COLUNAS */

INSERT INTO CLIENTE VALUES ('JOAO','M','JOAO@GMAIL.COM',12569878,'22658910',
'MAIA LACERTDA - ESTACIO - RIO DE JANEIRO - RJ' );

INSERT INTO CLIENTE VALUES ('CELIA','F','CELIA@GMAIL.COM',1234585,'25634656','RIACHUELO - 
CENTRO - RIO DE JANEIRO - RJ');

INSERT INTO CLIENTE VALUES ('JORGE','M', NULL, 321321, '213123',
'OSCAR CURY - BOM RETIRO - PATOS DE MINAS - MG');

/* FOMRA 02 - ESPECIFICANDO AS COLUNAS */

INSERT INTO CLIENTE (NOME, CPF, TELEFONE, EMAIL) VALUES ('LETICIAS',465435,'35435455','LETICIA@GMAIL.COM');

/* FORMA 03 - FORMA COMPACTA - FUNCIONA SOMENTE NO MYSQL */ 
INSERT INTO CLIENTE VALUES ('MARCELA','F','MARCELA@GMAIL.COM',351355,'4534543','AVENIDA VIA EXPRESSA - MG')
, ('FERNANDA','F','FEFE@GMAIL.COM',54545455,'23545335','CENTRO DE BH - MG');
...
SELECT NOW() AS DATA_HORA, 'EDUARDO CUNHA' AS PROFESSOR;

SELECT 'EDUARDO CUNHA';

SELECT 'BANCO DE DADOS';

/* ATLAS DE COLUNAS - SELECT É PROJETAR */ 

SELECT NOME AS CLIENTE, SEXO, EMAIL FROM CLIENTE;

SELECT NOME, SEXO, EMAIL, ENDERECO FROM CLIENTE;

/* SELECT * CLIENTE, É UM COMANDO QUE TRAZ TUDO DA TABELA, APENAS PARA FINS ACADEMICOS*/
...
SELECT NOME, SEXO FROM CLIENTE
WHERE ENDERECO = 'RJ';  /* DEU EMPTY VALUE PQ O IGUAL SO SERVE SE FOR EXATAMENTE IGUAL */
...
/* CARCTER CORGINA % -> QUALQUER COISA */
...
SELECT NOME, SEXO, ENDERECO FROM CLIENTE
WHERE ENDERECO LIKE 'MAIA%';

SELECT NOME, SEXO, ENDERECO FROM CLIENTE
WHERE ENDERECO LIKE '%ESTACIO%';

/* EXERCÍCIO DA BLIBLIOTECA */
...
INSERT INTO LIVRO VALUES ('CAVALEIRO REAL','ANA CLAUDIA','F',465,'ATLAS',49.3,'RJ','2009'),
	...
	('CASA MARROM','HERMES MACEDO','M',250,'BUBBA',60,'MG','2016'),
	('ESTACIO QUERIDO','GERALDO FRANCISCO','M',310,'INSIGNIA',100,'ES','2015'),
	('PRA SEMPRE AMIGAS','LEDA SILVA','F',510,'INSIGNIA',78.98,'ES','2011'),
	('COPAS INESQUECIVEIS','MARCA ALCANTARA','M',200,'LARSON',130.98,'RS','2018'),
	('O PODER DA MENTE','CLARA MAFRA','F',120,'CONTINENTAL',56.58,'RS','2017');
	
/* ALTEREI DE DECIMAL PARA NUMERIC */	
	
SELECT NOME, EDITORA FROM LIVRO;

SELECT NOME, UF_DA_EDITORA FROM LIVRO WHERE SEXO_DO_AUTOR = 'M';

SELECT NOME, NUMERO_DE_PAGINAS FROM LIVRO WHERE SEXO_DO_AUTOR = 'F';

SELECT VALOR FROM LIVRO WHERE UF_DA_EDITORA = 'SP';   ,

SELECT NOME, AUTOR, NUMERO_DE_PAGINAS, EDITORA, VALOR, ANO FROM LIVRO 
WHERE SEXO_DO_AUTOR = 'M' AND (UF_DA_EDITORA = 'SP' OR UF_DA_EDITORA = 'RJ');


/* OPERADORES LÓGICOS */ 

SELECT NOME, ENDERECO, SEXO FROM CLIENTE WHERE SEXO = 'M' OR ENDERECO LIKE = '%RJ';


SELECT NOME, ENDERECO, SEXO FROM CLIENTE WHERE SEXO = 'M' AND ENDERECO LIKE = '%RJ';
...
SELECT COUNT(*) AS 'Quantidade de registros da tabela' FROM CLIENTE; 
...
SELECT * FROM CLIENTE
WHERE EMAIL = NULL;  
/* FORMA ERRADA, FORMA CORRETA ABAIXO */
...
UPDATE CLIENTE
SET EMAIL = 'LILIAN@GMGM.COM';

/* DELETANDO REGISTRO COM A CLÁUSULA DELETE */
...
REGRA 1 - TODO CAMPO VETORIIZADO SE TORNARÁ OUTRA TABELA
